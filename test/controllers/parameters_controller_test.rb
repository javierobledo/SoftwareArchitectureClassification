...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { algorithm_id: @parameter.algorithm_id, name: @parameter.name, typeof: @parameter.typeof } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { algorithm_id: @parameter.algorithm_id, name: @parameter.name, typeof: @parameter.typeof } }
