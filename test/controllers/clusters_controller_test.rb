...
class ClustersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cluster" do
    assert_difference('Cluster.count') do
      post clusters_url, params: { cluster: { classification_id: @cluster.classification_id, name: @cluster.name, parent_id: @cluster.parent_id } }
    end
  ...
  test "should update cluster" do
    patch cluster_url(@cluster), params: { cluster: { classification_id: @cluster.classification_id, name: @cluster.name, parent_id: @cluster.parent_id } }
