...
class ClassificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post classifications_url, params: { classification: { algorithm_id: @classification.algorithm_id, name: @classification.name, preprocessing_id: @classification.preprocessing_id } }
    end
  ...
  test "should update classification" do
    patch classification_url(@classification), params: { classification: { algorithm_id: @classification.algorithm_id, name: @classification.name, preprocessing_id: @classification.preprocessing_id } }
