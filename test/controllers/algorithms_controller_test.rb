...
class AlgorithmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create algorithm" do
    assert_difference('Algorithm.count') do
      post algorithms_url, params: { algorithm: { DOI: @algorithm.DOI, description: @algorithm.description, name: @algorithm.name } }
    end
  ...
  test "should update algorithm" do
    patch algorithm_url(@algorithm), params: { algorithm: { DOI: @algorithm.DOI, description: @algorithm.description, name: @algorithm.name } }
